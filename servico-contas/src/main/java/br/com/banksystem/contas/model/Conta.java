...
public class Conta {
    ...
    public String getSenhaTransferenciaHash() {
        return senhaTransferenciaHash;
    }

    public void setSenhaTransferenciaHash(String h) {
        this.senhaTransferenciaHash = h;
    }
    ...
    public void setTokenVerificacaoEmail(String t) {
        this.tokenVerificacaoEmail = t;
    }

    public LocalDateTime getTokenVerificacaoExpiracao() {
        return tokenVerificacaoExpiracao;
    }

    public void setTokenVerificacaoExpiracao(LocalDateTime t) {
        this.tokenVerificacaoExpiracao = t;
    }
